...
# [usage]
# python img2txt_tesseract_advance.py a.jpg
...
def OCR_lmj(IMG_FILE_PATH):
    image = Image.open(IMG_FILE_PATH)  # 打开图片文件
...
def main():
    ...
    # 识别指定文件目录下的图片
    # 图片存放目录figures
    dir = '/home/stela/Desktop/video_to_image'
    ...
    for file in os.listdir(dir):
        if file.endswith('.png') or file.endswith('.jpg'):
            # print(file)
            IMG_FILE_PATH = '%s/%s' % (dir, file)  # 图片路径

            answer = file.split('.')[0]  # 图片名称，即图片中的正确文字
            recognizition = OCR_lmj(IMG_FILE_PATH)  # 图片识别的文字结果
    ...
    # 单张图片识别
    # IMG_FILE_PATH = '/home/stela/Desktop/video_to_image/295.jpg'
    OCR_lmj(IMG_FILE_PATH)
